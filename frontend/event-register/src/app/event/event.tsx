...
import { MagnifyingGlassIcon,PlusIcon,Cross2Icon,MixIcon, LapTimerIcon, PersonIcon,SewingPinFilledIcon,ClockIcon, DrawingPinFilledIcon, ExclamationTriangleIcon, CheckIcon, ChevronUpIcon, ChevronDownIcon, HomeIcon, Pencil2Icon, CalendarIcon,ShuffleIcon,ExitIcon} from "@radix-ui/react-icons";
...
export default function Events({ onGoToReview, setSelectedEvent }: { onGoToReview: () => void; setSelectedEvent: (event: any) => void }) {
   ...
   return (
      <div id = "events-list-div" className='flex flex-col border-2 border-solid border-white/[.08]'>   
         <div id = "title-events" className="flex flex-col gap-3 relative border-2 border-solid border-white/[.08]">
         ...
         <div id = "filter-events" className="flex flex-row gap-2"> 
                     ...
                     <Dialog.Trigger asChild>
                        {isOrganizer && 
                           <Button id="create-event" type = "submit" className="flex items-center gap-3">
                              <PlusIcon id="plus-icon" radius={"full"}/>
                           </Button>
                     }              
                     </Dialog.Trigger>   
                     <Dialog.Portal>
                           ...
                           <div className="flex flex-col gap-3 py-2"> 
                              <div className="flex flex-row items-center gap-5">
                                 <div className="flex flex-col gap-1">
                                    <label  id= "label-create-event" htmlFor="event_name">Event name</label>
                                    <input
                                       id = "input-event"  
                                       name = "event_name"
                                       placeholder="event1"
                                 ...
                                 <div className="flex flex-col gap-1">
                                    <label id= "label-create-event" htmlFor="event-type">Event type</label>
                                    <input
                                       id = "input-event"  
                                       name = "event_type"
                                       placeholder="type1"
                              ...
                              <div className="flex flex-row items-center gap-5">
                                 <div className="flex flex-col gap-1">                        
                                       <label id= "label-create-event" htmlFor="event-edition">Event edition</label>
                                       <input
                                          id = "input-event"  
                                          name = "event_edition"
                                 ...
                                 <div className="flex flex-col gap-1">                        
                                          <label id= "label-create-event" htmlFor="event-category">Event category</label>
                                          <input
                                             id = "input-event"  
                                             name = "event_category"
            ...
            <div id = "div-filter-select-time" className="flex flex-row gap-2">
               ...
               <div className = "flex flex-rows items-center"onChange={findEventByDate}>
                  <div id = "filter-by-date" className="flex flex-row gap-2 items-center px-4">
                     <label id="filter-date" >Start date</label>
                     <input
                        id = "input-date"  
                  ...
                  <div id = "filter-by-date" className="flex flex-row gap-2 items-center px-2">
                     <label id="filter-date" >End date</label>
                     <input
                        id = "input-date"  
