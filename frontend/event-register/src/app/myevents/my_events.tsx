...
import { Heading, Flex,Box,Badge, AlertDialog, Button} from "@radix-ui/themes";
import {MixIcon,LapTimerIcon, PersonIcon,ClockIcon,TrashIcon,Pencil1Icon,Cross2Icon} from "@radix-ui/react-icons";
               ...
               events.map((event) => (
                  ...
                  >
                     ...
                     <div  id = "info-date-myevent-div"className="flex flex-row items-center">
                        <LapTimerIcon/> 
                        <span id="event-date">{event.celebration_date.split("T")[0]}</span>  
                     </div>   
                     <div  id = "info-clock-myevent-div"className="flex flex-row items-center">
                        <ClockIcon/> 
                        <span id="event-date">{event.celebration_date.split("T")[1]}</span>  
                     </div>
